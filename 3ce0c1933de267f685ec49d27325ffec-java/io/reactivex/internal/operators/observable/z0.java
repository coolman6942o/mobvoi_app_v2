...
public final class z0<T, R> extends io.reactivex.internal.operators.observable.a<T, R> {
    ...
    final o<? super T, ? extends v<? extends R>> f29159b;

    /* renamed from: c  reason: collision with root package name */
    final boolean f29160c;
    ...
    static final class a<T, R> extends AtomicInteger implements r<T>, b {
        ...
        /* loaded from: classes3.dex */
        final class C0342a extends AtomicReference<b> implements u<R>, b {
        ...
        void g(a<T, R>.C0342a aVar, Throwable th2) {
            this.set.a(aVar);
        ...
        void h(a<T, R>.C0342a aVar, R r10) {
            this.set.a(aVar);
            if (get() == 0) {
                boolean z10 = false;
    ...
    public z0(p<T> pVar, o<? super T, ? extends v<? extends R>> oVar, boolean z10) {
        super(pVar);
        this.f29159b = oVar;
        this.f29160c = z10;
    }
    ...
    protected void subscribeActual(r<? super R> rVar) {
        this.f28426a.subscribe(new a(rVar, this.f29159b, this.f29160c));
    }
}
