...
public final class a extends bm.a {
    ...
    public BluetoothGattCharacteristic f27499w;

    /* renamed from: x  reason: collision with root package name */
    public BluetoothGattCharacteristic f27500x;

    /* renamed from: y  reason: collision with root package name */
    public BluetoothGattCharacteristic f27501y;

    /* renamed from: z  reason: collision with root package name */
    public BluetoothGattCharacteristic f27502z;
    ...
    public void p() {
        ...
        if (this.f27501y != null) {
            l(DfuException.ERROR_CONNECTION_TIMEOUT);
            boolean i12 = i(this.f27501y);
        ...
        if (bluetoothGattCharacteristic != null) {
            if (h(this.f5210e, bluetoothGattCharacteristic, true)) {
                ...
                b.k(z17, "readTempDeviceInfo:" + u10);
            } else {
                b.d(this.f5208c, "readTempDeviceInfo failed");
            }
        }
    ...
    public final void t() {
        ...
        if (bluetoothGattService != null) {
            ...
            if (characteristic4 == null) {
                ...
                b.j(c.b(this.f27502z.getProperties()));
            }
            ...
            if (characteristic6 == null) {
                ...
                b.j(c.b(this.f27501y.getProperties()));
            }
            int i10 = 65472;
            while (true) {
                if (i10 > 65487) {
            ...
            for (int i11 = 65504; i11 <= 65519; i11++) {
                ...
                if (characteristic8 == null) {
                    ...
                    b.d(z13, "not found image version characteristic:" + c11.toString());
                    return;
                }
                boolean z14 = this.f5206a;
                b.d(z14, "find image version characteristic: " + c11.toString());
