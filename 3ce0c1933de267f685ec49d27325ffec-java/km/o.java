...
public class o extends k {
    ...
    public QcConfig f30042z0;

    public o(Context context, DfuConfig dfuConfig, QcConfig qcConfig, b bVar) {
        super(context, dfuConfig, bVar);
        this.f30042z0 = qcConfig;
    }
    ...
    */
    public boolean Q0() {
        ...
        while (e()) {
            try {
                ...
                il.b.e(kl.a.b(this.f36607u) + ", " + e10.toString());
    ...
    public final void R0() {
        ...
        QcConfig qcConfig = this.f30042z0;
        if (qcConfig != null) {
            try {
    ...
    public void q() {
        ...
        try {
            try {
                ...
                il.b.c("ProcessorXS0011Seq running.");
                y10 = y();
            } catch (DfuException e10) {
                il.b.l(e10.toString());
                i10 = e10.getErrCode();
