...
public class n extends k {
    ...
    public QcConfig f30041z0;

    public n(Context context, DfuConfig dfuConfig, QcConfig qcConfig, b bVar) {
        super(context, dfuConfig, bVar);
        this.f30041z0 = qcConfig;
    }

    public final void O0() {
        il.b.d(this.f36587a, "force copy data image from active bank from inactive bank...");
        if (a1(10132)) {
            Z0(10132);
        }
        if (a1(10133)) {
    ...
    */
    ...
    public final void R0() {
        ...
        QcConfig qcConfig = this.f30041z0;
        if (qcConfig != null) {
            try {
    ...
    public final void V0() {
        ...
        while (true) {
            ...
            if (e0(this.E, 1) == 0) {
                ...
                L0();
                if (v().f6005k >= 6) {
                    z10 = v().t() == this.f30036w0;
                    if (z10) {
                        il.b.d(this.f36588b, "role swap success, bud role=" + v().t());
                        break;
                    }
                    il.b.d(this.f36587a, String.format(Locale.US, "rws swap not completed, hfpState=0x%02X,bud role(%d), target is %d", Integer.valueOf(al.b.g().f(1, M(this.F))), Integer.valueOf(v().t()), Integer.valueOf(this.f30036w0)));
                } else {
                    P0();
                    z10 = v().H() == 0;
                    if (z10) {
                        il.b.d(this.f36588b, String.format("role swap success, RwsUpdateFlag = 0x%02X", Integer.valueOf(v().H())));
                        break;
                    }
                    il.b.d(this.f36587a, String.format("rws state not read, RwsUpdateFlag = 0x%02X", Integer.valueOf(v().H())));
                }
            }
            i10++;
        }
    ...
    public final boolean W0() {
        ...
        if (!e()) {
            ...
            A0(u().g());
            if (!t().G() && this.P != 0) {
                if ((v().f6004j == 4 || v().f6004j == 6 || v().f6004j == 8 || v().f6004j == 13) && v().f6005k <= 4) {
                    il.b.d(this.f36587a, "clear soc data");
                    M0();
                }
                this.P = 0;
            }
    ...
    */
    ...
    public final boolean Z0(int i10) {
        ...
        u().D();
        if (this.f36587a) {
            il.b.j(String.format("forceCopyProcedure, imageId=0x%04X", Integer.valueOf(i10)));
            il.b.j(u().toString());
        }
        try {
            w0(i10);
