...
@d(c = "com.cardiex.arty.lite.networking.ApiRepository$addProfile$1", f = "ApiRepository.kt", l = {37, 40, 43}, m = "invokeSuspend")
/* loaded from: classes.dex */
public final class ApiRepository$addProfile$1 extends SuspendLambda implements p<l0, c<? super m>, Object> {
    ...
    public ApiRepository$addProfile$1(ApiRepository apiRepository, Profile profile, ApiResultCallback<Object> apiResultCallback, c<? super ApiRepository$addProfile$1> cVar) {
        super(2, cVar);
    ...
    public final c<m> create(Object obj, c<?> cVar) {
        ApiRepository$addProfile$1 apiRepository$addProfile$1 = new ApiRepository$addProfile$1(this.this$0, this.$profile, this.$callback, cVar);
        apiRepository$addProfile$1.L$0 = obj;
        return apiRepository$addProfile$1;
    }

    public final Object invoke(l0 l0Var, c<? super m> cVar) {
        return ((ApiRepository$addProfile$1) create(l0Var, cVar)).invokeSuspend(m.f28349a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            this.label = 1;
            obj = apiClient.addUserProfile(profile, this);
            if (obj == d10) {
                return d10;
            }
        } else if (i10 == 1) {
