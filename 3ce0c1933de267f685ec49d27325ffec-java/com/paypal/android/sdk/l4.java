...
public final class l4 {
    ...
    private TableLayout f21445a;

    /* renamed from: b  reason: collision with root package name */
    private TableRow f21446b;
    ...
    public l4(Context context) {
        ...
        this.f21445a = tableLayout;
        tableLayout.setColumnShrinkable(0, true);
        this.f21445a.setColumnStretchable(1, true);
        TableRow tableRow = new TableRow(context);
        this.f21446b = tableRow;
        this.f21445a.addView(tableRow);
        u1.n(this.f21446b, -2, "30dip");
        this.f21446b.setGravity(3);
        ...
        this.f21446b.addView(imageView);
        u1.n(imageView, -2, "30dip");
        u1.y(imageView, "0dip", "0dip", "0dip", "0dip");
        u1.l(imageView, 3, 1.0f);
        TableRow tableRow2 = new TableRow(context);
        this.f21445a.addView(tableRow2);
        TextView textView = new TextView(context);
        this.f21447c = textView;
        textView.setTextSize(18.0f);
        this.f21447c.setTypeface(t1.E);
        this.f21447c.setSingleLine(true);
        this.f21447c.setGravity(83);
        this.f21447c.setTextColor(t1.f21996w);
        tableRow2.addView(this.f21447c);
        u1.m(this.f21447c, -2, -1);
        TableRow tableRow3 = new TableRow(context);
        this.f21445a.addView(tableRow3);
        TextView textView2 = new TextView(context);
        this.f21448d = textView2;
        textView2.setTextColor(t1.f21979f);
        this.f21448d.setTextSize(14.0f);
        this.f21448d.setPaintFlags(8);
        tableRow3.addView(this.f21448d);
        this.f21448d.setGravity(19);
        u1.y(this.f21448d, "0dip", "4dip", "0dip", "4dip");
        u1.m(this.f21448d, -2, -2);
        this.f21448d.setClickable(true);
    }
    ...
    public final void b(View.OnClickListener onClickListener) {
        this.f21448d.setOnClickListener(onClickListener);
    }

    public final void c(String str) {
        this.f21447c.setText(str);
    }

    public final void d() {
        this.f21448d.setText(z3.a(ft.LOG_OUT));
    }
}
