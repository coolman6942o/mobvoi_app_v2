    ...
    private void getSimCountryCode(Context context, boolean z10) {
        ...
        if (telephonyManager != null) {
            if (!z10 || telephonyManager.getPhoneType() == 2) {
                ...
                String str = TAG;
                SmartLog.e(str, "getSimCountryCode by not enableNetwork, countryCode=" + this.countryCode);
            } else {
                this.countryCode = telephonyManager.getNetworkCountryIso();
                this.countrySource = "NETWORK_COUNTRY";
                String str2 = TAG;
                SmartLog.e(str2, "getSimCountryCode by enableNetwork, countryCode=" + this.countryCode);
            }
        }
        checkCodeLenth();
    }
