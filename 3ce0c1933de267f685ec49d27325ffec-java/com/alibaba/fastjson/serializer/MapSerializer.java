...
public final class MapSerializer implements ObjectSerializer {
    ...
    public void write(JSONSerializer jSONSerializer, Object obj, Object obj2, Type type) throws IOException {
        ...
        boolean z11 = (cls == JSONObject.class || cls == HashMap.class || cls == LinkedHashMap.class) && map.containsKey(JSON.DEFAULT_TYPE_KEY);
        ...
        if (identityHashMap == null || !identityHashMap.containsKey(obj)) {
            ...
            try {
                ...
                if ((serializeWriter.features & SerializerFeature.WriteClassName.mask) == 0 || z11) {
                    z10 = true;
                } else {
