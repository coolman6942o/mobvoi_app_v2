...
public class b {
    ...
    private static final ThreadLocal<Matrix> f11051a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal<RectF> f11052b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f11051a;
        ...
        ThreadLocal<RectF> threadLocal2 = f11052b;
