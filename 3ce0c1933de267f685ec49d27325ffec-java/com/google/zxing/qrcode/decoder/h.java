...
public final class h {
    ...
    private static final int[] f13466e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f  reason: collision with root package name */
    private static final h[] f13467f = b();
    ...
    private h(int i10, int[] iArr, b... bVarArr) {
        a[] a10;
        this.f13468a = i10;
        this.f13469b = iArr;
        this.f13470c = bVarArr;
        int b10 = bVarArr[0].b();
        int i11 = 0;
    ...
    public static h g(int i10) throws FormatException {
        if (i10 % 4 == 1) {
            try {
                return i((i10 - 17) / 4);
    ...
    public com.google.zxing.common.b a() {
        int e10 = e();
        com.google.zxing.common.b bVar = new com.google.zxing.common.b(e10);
        bVar.n(0, 0, 9, 9);
        int i10 = e10 - 8;
        bVar.n(i10, 0, 8, 9);
        bVar.n(0, i10, 9, 8);
        int length = this.f13469b.length;
        for (int i11 = 0; i11 < length; i11++) {
            int i12 = this.f13469b[i11] - 2;
            for (int i13 = 0; i13 < length; i13++) {
                if (!((i11 == 0 && (i13 == 0 || i13 == length - 1)) || (i11 == length - 1 && i13 == 0))) {
                    bVar.n(this.f13469b[i13] - 2, i12, 5, 5);
                }
            }
        }
        int i14 = e10 - 17;
    ...
    public int e() {
        return (this.f13468a * 4) + 17;
    }

    public b f(ErrorCorrectionLevel errorCorrectionLevel) {
        return this.f13470c[errorCorrectionLevel.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f13468a);
    }
}
