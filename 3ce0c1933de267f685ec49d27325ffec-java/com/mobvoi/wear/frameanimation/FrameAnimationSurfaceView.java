...
public final class FrameAnimationSurfaceView extends SurfaceView implements AnimationController {
    ...
    private FrameAnimationSurfaceView(Context context, AttributeSet attributeSet, int i10, FrameAnimation frameAnimation) {
    ...
    public /* synthetic */ FrameAnimationSurfaceView(Context context, AttributeSet attributeSet, int i10, int i11, f fVar) {
        this(context, (i11 & 2) != 0 ? null : attributeSet, (i11 & 4) != 0 ? 0 : i10);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public FrameAnimationSurfaceView(Context context, AttributeSet attributeSet, int i10) {
