...
public final class PulseCardViewHolder extends i {
    ...
    public PulseCardViewHolder(ViewGroup parentView) {
    ...
    protected void onBindData(b<?> data) {
        ...
        if (data instanceof xc.i) {
            ...
            if (iVar.a() != null) {
                ...
                this.tvLatestValue.setText(ifZeroReturnEmptyStr(getContext(), iVar.a().f18273c.f18283e));
            }
        }
    }
