...
public final class AtrialFibrillationCardViewHolder extends i {
    ...
    public AtrialFibrillationCardViewHolder(ViewGroup parentView) {
    ...
    public static final void m11onBindData$lambda1(AtrialFibrillationCardViewHolder this$0, View view) {
        i.f(this$0, "this$0");
    ...
    protected void onBindData(b<?> data) {
        ...
        if ((data instanceof h) && data.c()) {
            ...
            int i10 = R.string.heart_atrial_fibrillation_day_warn;
            Object[] objArr = new Object[1];
            a a10 = ((h) data).a();
            objArr[0] = a10 == null ? null : getTimeString(a10.f33515b);
            textView.setText(context.getString(i10, objArr));
        }
        this.ivNotice.setOnClickListener(new View.OnClickListener() { // from class: com.mobvoi.companion.health.viewholder.c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                AtrialFibrillationCardViewHolder.m11onBindData$lambda1(AtrialFibrillationCardViewHolder.this, view);
            }
        });
    }
    ...
    protected void onItemClick(b<?> data, int i10, a controlInterface) {
        ...
        sb.a.d(getContext(), "atrialFibCard");
        ...
        if ((data instanceof h) && data.c() && (a10 = ((h) data).a()) != null) {
            ...
            if (sharedPreferences.getLong("vpa_heart_health_atrial_fibrillation", -1L) != j10) {
                sharedPreferences.edit().putLong("vpa_heart_health_atrial_fibrillation", j10).apply();
            }
        }
