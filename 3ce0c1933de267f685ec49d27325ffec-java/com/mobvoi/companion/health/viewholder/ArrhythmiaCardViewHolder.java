...
public final class ArrhythmiaCardViewHolder extends i {
    ...
    public static final void m10onBindData$lambda1(ArrhythmiaCardViewHolder this$0, View view) {
        i.f(this$0, "this$0");
    ...
    protected void onBindData(b<?> data) {
        ...
        if ((data instanceof h) && data.c()) {
            ...
            a a10 = hVar.a();
            String str = null;
            Integer valueOf = a10 == null ? null : Integer.valueOf(a10.f33514a);
            TextView textView = this.tvValue;
            Context context = getContext();
            if (valueOf != null && valueOf.intValue() == 2) {
                i10 = R.string.heart_rate_too_fast_day_warn;
            } else {
                i10 = R.string.heart_rate_too_slow_day_warn;
            }
            Object[] objArr = new Object[1];
            a a11 = hVar.a();
            if (a11 != null) {
                str = getTimeString(a11.f33515b);
            }
            objArr[0] = str;
        ...
        this.ivNotice.setOnClickListener(new View.OnClickListener() { // from class: com.mobvoi.companion.health.viewholder.b
            ...
            public final void onClick(View view) {
                ArrhythmiaCardViewHolder.m10onBindData$lambda1(ArrhythmiaCardViewHolder.this, view);
            }
        });
    }
    ...
    protected void onItemClick(b<?> data, int i10, a controlInterface) {
        ...
        sb.a.d(getContext(), "arrhythmiaCard");
