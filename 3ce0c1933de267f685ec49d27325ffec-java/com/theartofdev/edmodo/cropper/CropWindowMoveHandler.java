...
final class CropWindowMoveHandler {
    ...
    private final float f23149a;

    /* renamed from: b  reason: collision with root package name */
    private final float f23150b;
    ...
    private final Type f23153e;

    /* renamed from: f  reason: collision with root package name */
    private final PointF f23154f = new PointF();
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f23155a[Type.TOP_RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f23155a[Type.BOTTOM_LEFT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f23155a[Type.BOTTOM_RIGHT.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f23155a[Type.LEFT.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f23155a[Type.TOP.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f23155a[Type.RIGHT.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f23155a[Type.BOTTOM.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f23155a[Type.CENTER.ordinal()] = 9;
    ...
    private void a(RectF rectF, float f10, RectF rectF2, int i10, float f11, float f12, boolean z10, boolean z11) {
        ...
        if (f10 > f13) {
            ...
            this.f23154f.y -= (f10 - f13) / 1.1f;
        }
        float f14 = rectF2.bottom;
        if (f10 > f14) {
            this.f23154f.y -= (f10 - f14) / 2.0f;
        }
        if (f14 - f10 < f11) {
            f10 = f14;
        }
        float f15 = rectF.top;
        float f16 = this.f23150b;
        if (f10 - f15 < f16) {
            f10 = f15 + f16;
        }
        float f17 = this.f23152d;
        if (f10 - f15 > f17) {
            f10 = f15 + f17;
        }
        if (f14 - f10 < f11) {
    ...
    private void c(RectF rectF, float f10, RectF rectF2, float f11, float f12, boolean z10, boolean z11) {
        if (f10 < 0.0f) {
            f10 /= 1.05f;
            this.f23154f.x -= f10 / 1.1f;
        }
        float f13 = rectF2.left;
        if (f10 < f13) {
            this.f23154f.x -= (f10 - f13) / 2.0f;
        }
        if (f10 - f13 < f11) {
            f10 = f13;
        }
        float f14 = rectF.right;
        float f15 = this.f23149a;
        if (f14 - f10 < f15) {
            f10 = f14 - f15;
        }
        float f16 = this.f23151c;
        if (f14 - f10 > f16) {
            f10 = f14 - f16;
        }
        if (f10 - f13 < f11) {
    ...
    private void f(RectF rectF, float f10, RectF rectF2, int i10, float f11, float f12, boolean z10, boolean z11) {
        ...
        if (f10 > f13) {
            f10 = ((f10 - f13) / 1.05f) + f13;
            this.f23154f.x -= (f10 - f13) / 1.1f;
        }
        float f14 = rectF2.right;
        if (f10 > f14) {
            this.f23154f.x -= (f10 - f14) / 2.0f;
        }
        if (f14 - f10 < f11) {
            f10 = f14;
        }
        float f15 = rectF.left;
        float f16 = this.f23149a;
        if (f10 - f15 < f16) {
            f10 = f15 + f16;
        }
        float f17 = this.f23151c;
        if (f10 - f15 > f17) {
            f10 = f15 + f17;
        }
        if (f14 - f10 < f11) {
        ...
        if (f12 > 0.0f) {
            float f18 = (f10 - f15) / f12;
            float f19 = this.f23150b;
            if (f18 < f19) {
                f10 = Math.min(f14, f15 + (f19 * f12));
                f18 = (f10 - rectF.left) / f12;
            }
            float f20 = this.f23152d;
            if (f18 > f20) {
    ...
    private void h(RectF rectF, float f10, RectF rectF2, float f11, float f12, boolean z10, boolean z11) {
        if (f10 < 0.0f) {
            f10 /= 1.05f;
            this.f23154f.y -= f10 / 1.1f;
        }
        float f13 = rectF2.top;
        if (f10 < f13) {
            this.f23154f.y -= (f10 - f13) / 2.0f;
        }
        if (f10 - f13 < f11) {
            f10 = f13;
        }
        float f14 = rectF.bottom;
        float f15 = this.f23150b;
        if (f14 - f10 < f15) {
            f10 = f14 - f15;
        }
        float f16 = this.f23152d;
        if (f14 - f10 > f16) {
            f10 = f14 - f16;
        }
        if (f10 - f13 < f11) {
        ...
        if (f12 > 0.0f) {
            float f17 = (f14 - f10) * f12;
            float f18 = this.f23149a;
            if (f17 < f18) {
                f10 = Math.max(f13, f14 - (f18 / f12));
                f17 = (rectF.bottom - f10) * f12;
            }
            float f19 = this.f23151c;
            if (f17 > f19) {
    ...
    private void l(RectF rectF, float f10, float f11) {
        ...
        float f14;
        float f15 = 0.0f;
        switch (a.f23155a[this.f23153e.ordinal()]) {
            case 1:
                f15 = rectF.left - f10;
                f13 = rectF.top;
                f12 = f13 - f11;
