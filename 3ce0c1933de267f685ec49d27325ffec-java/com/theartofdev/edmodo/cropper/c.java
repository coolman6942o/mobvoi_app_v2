...
public final class c {
    ...
    static final Rect f23189a = new Rect();

    /* renamed from: b  reason: collision with root package name */
    static final RectF f23190b = new RectF();

    /* renamed from: c  reason: collision with root package name */
    static final RectF f23191c = new RectF();

    /* renamed from: d  reason: collision with root package name */
    static final float[] f23192d = new float[6];

    /* renamed from: e  reason: collision with root package name */
    static final float[] f23193e = new float[6];

    /* renamed from: f  reason: collision with root package name */
    private static int f23194f;

    /* renamed from: g  reason: collision with root package name */
    static Pair<String, WeakReference<Bitmap>> f23195g;
        ...
        do {
            ...
            try {
                try {
                    ...
                    Bitmap decodeStream = BitmapFactory.decodeStream(inputStream, f23189a, options);
                    c(inputStream);
                    return decodeStream;
    ...
    private static BitmapFactory.Options k(ContentResolver contentResolver, Uri uri) throws FileNotFoundException {
        ...
        try {
            ...
            try {
                ...
                BitmapFactory.decodeStream(inputStream, f23189a, options);
    ...
    public static a l(Context context, Uri uri, int i10, int i11) {
        try {
            ...
            k10.inSampleSize = Math.max(b(k10.outWidth, k10.outHeight, i10, i11), a(k10.outWidth, k10.outHeight));
