...
public class x0 {
    ...
    public static x0 a(Context context) {
        ...
        synchronized (x0.class) {
            if (f5602b == null) {
                f5602b = new x0(context);
            }
        }
        return f5602b;
    }

    private static boolean b(PackageInfo packageInfo, boolean z10) {
        ...
        return z10 ? c(packageInfo, f5603c, f5604d) : c(packageInfo, f5603c);
    }
    ...
    private final PackageInfo f(String str) {
        try {
            return c.a(this.f5605a).d(str, 64);
