...
final class g {
    ...
    private final List<int[]> f35653a = new ArrayList();

    /* renamed from: b  reason: collision with root package name */
    private final List<String> f35654b = new ArrayList();

    private void a(int[] iArr, String str) {
        this.f35653a.add(iArr);
    ...
    private synchronized void b() {
        if (this.f35653a.isEmpty()) {
            ...
            a(new int[]{385}, "HR");
            a(new int[]{387}, "BA");
            a(new int[]{AGCServerException.AUTHENTICATION_INVALID, 440}, "DE");
            ...
            a(new int[]{AGCServerException.UNKNOW_EXCEPTION, 509}, "GB");
            a(new int[]{DfuException.ERROR_REMOTE_FLASH_ERASE_ERROR}, "GR");
            a(new int[]{528}, "LB");
            a(new int[]{529}, "CY");
            a(new int[]{531}, "MK");
            a(new int[]{535}, "MT");
    ...
    public String c(String str) {
        ...
        int size = this.f35653a.size();
        for (int i11 = 0; i11 < size && parseInt >= (i10 = (iArr = this.f35653a.get(i11))[0]); i11++) {
            if (iArr.length != 1) {
                i10 = iArr[1];
            }
            if (parseInt <= i10) {
                return this.f35654b.get(i11);
            }
        }
        return null;
    }
