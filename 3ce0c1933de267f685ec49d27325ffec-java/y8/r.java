...
final class r {
    ...
    private static final Object f36792a;

    /* renamed from: b  reason: collision with root package name */
    private static final Object[][] f36793b;

    /* renamed from: c  reason: collision with root package name */
    private static final Object[][] f36794c;

    /* renamed from: d  reason: collision with root package name */
    private static final Object[][] f36795d;

    /* renamed from: e  reason: collision with root package name */
    private static final Object[][] f36796e;
    ...
    public static String a(String str) throws NotFoundException {
        ...
        if (str.length() >= 2) {
            ...
            for (Object[] objArr5 : f36793b) {
                if (objArr5[0].equals(substring)) {
                    if (objArr5[1] == f36792a) {
            ...
            if (str.length() >= 3) {
                ...
                for (Object[] objArr6 : f36794c) {
                    if (objArr6[0].equals(substring2)) {
                        if (objArr6[1] == f36792a) {
                ...
                for (Object[] objArr7 : f36795d) {
                    if (objArr7[0].equals(substring2)) {
                        if (objArr7[1] == f36792a) {
                ...
                if (str.length() >= 4) {
                    ...
                    for (Object[] objArr8 : f36796e) {
                        if (objArr8[0].equals(substring3)) {
                            if (objArr8[1] == f36792a) {
