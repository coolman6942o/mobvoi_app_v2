...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2 extends SuspendLambda implements p<c<Object>, c<? super m>, Object> {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2(b[] bVarArr, c cVar, r rVar) {
        super(2, cVar);
        this.$flows = bVarArr;
        this.$transform$inlined = rVar;
    }
    ...
    public final Object invoke(c<Object> cVar, c<? super m> cVar2) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2) create(cVar, cVar2)).invokeSuspend(m.f28349a);
    }
