...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements p<c<Object>, c<? super m>, Object> {
    ...
    public static final class AnonymousClass1 extends Lambda implements a<T[]> {
        ...
        public AnonymousClass1(b<T>[] bVarArr) {
            super(0);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public FlowKt__ZipKt$combineTransform$7(b<T>[] bVarArr, q<? super c<Object>, ? super T[], ? super c<? super m>, ? extends Object> qVar, c<? super FlowKt__ZipKt$combineTransform$7> cVar) {
        super(2, cVar);
        this.$flowArray = bVarArr;
        this.$transform = qVar;
    }
    ...
    public final Object invoke(c<Object> cVar, c<? super m> cVar2) {
        return ((FlowKt__ZipKt$combineTransform$7) create(cVar, cVar2)).invokeSuspend(m.f28349a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            h.b(obj);
            b<T>[] bVarArr = this.$flowArray;
            i.j();
            AnonymousClass1 r32 = new AnonymousClass1(this.$flowArray);
            i.j();
    ...
    public final Object invokeSuspend$$forInline(Object obj) {
        b<T>[] bVarArr = this.$flowArray;
        i.j();
        AnonymousClass1 r12 = new AnonymousClass1(this.$flowArray);
        i.j();
