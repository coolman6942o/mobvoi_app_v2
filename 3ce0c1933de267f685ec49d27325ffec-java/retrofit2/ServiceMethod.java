...
public final class ServiceMethod<R, T> {
    ...
    private final Converter<c0, R> responseConverter;
    ...
    public static final class Builder<T, R> {
        ...
        Converter<c0, T> responseConverter;
        Type responseType;
        ...
        private Converter<c0, T> createResponseConverter() {
            try {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i10, Type type, Annotation[] annotationArr, Annotation annotation) {
            if (annotation instanceof Url) {
                    ...
                    if (!value5.isEmpty()) {
                        ...
                        if (Iterable.class.isAssignableFrom(rawType8)) {
                            if (type instanceof ParameterizedType) {
                                ...
                                if (!x.c.class.isAssignableFrom(Utils.getRawType(parameterUpperBound4))) {
                                    return new ParameterHandler.Part(of2, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                                }
                            ...
                            throw parameterError(i10, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
                        } else if (rawType8.isArray()) {
                            Class<?> boxIfPrimitive = ServiceMethod.boxIfPrimitive(rawType8.getComponentType());
                            if (!x.c.class.isAssignableFrom(boxIfPrimitive)) {
                                return new ParameterHandler.Part(of2, this.retrofit.requestBodyConverter(boxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                            }
                            throw parameterError(i10, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        } else if (!x.c.class.isAssignableFrom(rawType8)) {
                            return new ParameterHandler.Part(of2, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                        } else {
                            throw parameterError(i10, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        }
                        ...
                        if (!(type instanceof ParameterizedType)) {
                            throw parameterError(i10, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
                        } else if (x.c.class.isAssignableFrom(Utils.getRawType(Utils.getParameterUpperBound(0, (ParameterizedType) type)))) {
                        ...
                        if (x.c.class.isAssignableFrom(rawType8.getComponentType())) {
                    ...
                    if (Map.class.isAssignableFrom(rawType9)) {
                        ...
                        if (supertype4 instanceof ParameterizedType) {
                            ...
                            if (String.class == parameterUpperBound5) {
                                ...
                                if (!x.c.class.isAssignableFrom(Utils.getRawType(parameterUpperBound6))) {
                            ...
                            throw parameterError(i10, "@PartMap keys must be of type String: " + parameterUpperBound5, new Object[0]);
                        }
                        throw parameterError(i10, "Map must include generic types (e.g., Map<String, String>)", new Object[0]);
                    }
                ...
                if (this.isFormEncoded || this.isMultipart) {
                    ...
                    try {
                        Converter<T, a0> requestBodyConverter = this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations);
                        this.gotBody = true;
        ...
        public ServiceMethod build() {
            ...
            if (responseType == Response.class || responseType == b0.class) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public z toRequest(Object... objArr) throws IOException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public R toResponse(c0 c0Var) throws IOException {
        return this.responseConverter.convert(c0Var);
    }
}
